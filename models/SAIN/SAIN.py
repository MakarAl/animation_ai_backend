...
class SAIN(nn.Module):
    def __init__(self, args):
        ...
        self.weight1 = torch.randn(3, device=self.device)
        self.weight2 = torch.randn(3, device=self.device)
        self.weight3 = torch.randn(3, device=self.device)
        self.weight4 = torch.randn(3, device=self.device)
